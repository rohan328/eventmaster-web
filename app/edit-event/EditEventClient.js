          ...
          <main className={styles.content}>
            ...
            {savedSummary && (
              <p className={styles.bannerSuccess} role="status">
                Event <strong>{savedSummary.title}</strong> ({savedSummary.status}) was
                updated.{" "}
                <Link href="/your-events" className={styles.inlineLink}>
                  Back to your events
                </Link>
            ...
            {loadingEvent ? (
              ...
              <form className={styles.form} onSubmit={handleUpdate}>
                ...
                <article className={styles.card}>
                  ...
                  <p className={styles.cardDescription}>
                    In-person and hybrid events need an address; online events need a
                    link. Optional coordinates power map pins.
                  </p>
                ...
                <article className={styles.card}>
                  ...
                  <p className={styles.cardDescription}>
                    Main start and end define the event window. Add optional agenda rows
                    for sessions or segments.
                  </p>
                ...
                <article className={styles.card}>
                  <h2 className={styles.cardTitle}>
                    Capacity, visibility &amp; ticketing
                  </h2>
                  <p className={styles.cardDescription}>
                    Capacity limits attendance. Ticketing supports free events or mock paid
                    pricing for demos.
                  </p>
                ...
                <article className={styles.card}>
                  ...
                  <p className={styles.cardDescription}>
                    Full detail for the event page — agenda highlights, speakers, and
                    expectations.
                  </p>
